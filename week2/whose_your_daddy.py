...
class Puzzle8Node(Node):
   ...
   def get_children(self):
      ...
      children = self.get_moves()#The moves are a list of children.
      i = 0
      while i < len(children):
         children[i].parent = self #The parent will be the puzzle8Node that you supply in get_children(self). Therefore, "self" is the parent and for every child of self, you can let self be the parent. Parent has to be initialised in the init method of the puzzle8Node class.
         i += 1
      return children
...
def main():
   puzzle = (Puzzle8Node('2831647 5'))
   children = puzzle.get_children()
   print(puzzle.name == children[0].get_parent().name)


if __name__ == "__main__":
   main()
#and here is the base Node class: