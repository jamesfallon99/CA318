...
def do_ga():
   ...
   #print(space)
   #for i in range(10, 145, 15):
   sol = optimization.genetic_algorithm(space, cost, elite_fraction = 0.4, pop_size = 50, mutation_rate =0.6, max_step = 100, max_iterations = 400)
   print(round(cost(sol), 3)) ##################################################Round to 3 decimal places.
...
##########################question 1 involved changing the "elite_fraction" argument above ^ from 0.1 to 1.0 and printing the value out to 3 decimal places#################################
######################question 2 involved chandging th pop_size from 10 to 145 in steps of 15
import sys
main(sys.argv)
