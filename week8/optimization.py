...
##################################################Your seed is 166. You need to use this in the random.seed() call.
...
def crossover(mummy, daddy):
   ...
   crossover_point = randint(1, len(mummy) - 2) #mummy here is the length of the gene

   gene = mummy[:crossover_point] + daddy[crossover_point:]#Gene: get the first half of mothers genes and 2nd half of fathers genes
   return gene
